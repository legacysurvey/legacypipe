...
indg = np.where((tbdata['filter'] == 'g') & (tbdata['photometric'] == True) & (tbdata['blacklist_ok'] == True))# & (tbdata['ra'] < 50.))# & (tbdata['dec'] < 21.))
#indg = np.where((tbdata['filter'] == 'g')  & (tbdata['ra'] < 50.))
#indg = np.where( (tbdata['ra'] < 50.))
