...
python $PROJECTPATH/legacypipe/py/legacypipe/runbrick.py --outdir=$outdir --no-wise --coadd-bw --nsigma=6 --force-all --radec 239.4632622 52.44810708 --no-gaia -W 48 -H 48 --pixscale=1.012 --no-splinesky #--threads=32 #--plots
#--stage fitblobs
