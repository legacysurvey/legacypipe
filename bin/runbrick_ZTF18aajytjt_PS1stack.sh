...
python $PROJECTPATH/legacypipe/py/legacypipe/runbrick.py --outdir=$outdir --coadd-bw --nsigma=5 --force-all --radec 211.315074 +54.416022 --unwise-dir $LEGACY_SURVEY_DIR/images --bands=1 --no-wise --old-calibs-ok --no-gaia
