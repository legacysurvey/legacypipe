...
export LEGACY_SURVEY_DIR=/project/projectdirs/uLens/ZTF/Tractor/data/ZTF18acbvnen/tractor/
...
python $PROJECTPATH/legacypipe/py/legacypipe/runbrick.py --outdir=$outdir --no-wise --coadd-bw --nsigma=6 --force-all --radec 105.935177 59.544834 --blobradec 105.935177 59.544834 --no-gaia #--plots
#--stage fitblobs
#--stage writecat
