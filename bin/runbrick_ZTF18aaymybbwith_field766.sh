...
export LEGACY_SURVEY_DIR=/project/projectdirs/uLens/ZTF/Tractor/data/ZTF18aaymybb_sci_withtransient_field766/tractor
...
python $PROJECTPATH/legacypipe/py/legacypipe/runbrick.py --outdir=$outdir --no-wise --coadd-bw --nsigma=8 --stage coadds --radec 288.656715 +50.481882 --blobradec 288.656715 50.481882 --no-gaia --threads=32 #--plots
#--stage fitblobs
#--force-all
#--stage writecat
