...
python -u legacypipe/runbrick.py --force-all -P 'pickles/runbrick-fftb-%(brick)s-%%(stage)s.pickle' --brick $brick --outdir $outdir --threads 6 --nsigma 6 --skip --pipe --pixpsf >> $log 2>&1
