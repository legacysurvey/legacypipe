...
export LEGACY_SURVEY_DIR=/project/projectdirs/uLens/ZTF/Tractor/data/ZTF18aaymybb_sci_withouttransient/tractor
...
python $PROJECTPATH/legacypipe/py/legacypipe/runbrick.py --outdir=$outdir --no-wise --coadd-bw --nsigma=6 --force-all --radec 288.656715 +50.481882 --blobradec 288.656715 50.481882 --threads=32 --no-gaia #--plots
#--stage fitblobs
#--stage writecat
