...
export LEGACY_SURVEY_DIR=/project/projectdirs/uLens/ZTF/Tractor/data/ZTF18aaxsgzq/tractor
...
python $PROJECTPATH/legacypipe/py/legacypipe/runbrick.py --outdir=$outdir --no-wise --coadd-bw --nsigma=6 --force-all --radec 249.262968 44.091763 --blobradec 249.262968 44.091763 #--plots
#--stage fitblobs
#--stage writecat
