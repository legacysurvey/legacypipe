...
python legacypipe/runbrick.py --brick 1867p255 --zoom 2050 2300 1150 1400 --outdir tc4 --force-all --no-write --no-wise -s image_coadds
python legacyanalysis/create_testcase.py tc4/coadd/186/1867p255/legacysurvey-1867p255-ccds.fits testcase4 1867p255
