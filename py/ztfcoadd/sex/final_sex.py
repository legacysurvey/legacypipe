...
def create_sex_cats(my_scie_list, debug):
    ...
    for i,scie in enumerate(my_scie_list):
        ...
        command = 'sex -c %s/legacypipe/pi/ztfcoadd/coadd/coadd.sex -WEIGHT_IMAGE %s -MAG_ZEROPOINT %s -VERBOSE_TYPE QUIET -CHECKIMAGE_NAME %s -CATALOG_NAME %s %s'%(utils.PROJECTPATH,weight,zp,noise,newcat,scie)
