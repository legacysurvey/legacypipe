...
def ps1_to_decam(psmags, band):
    ...
    coeffs = dict(
        ...
        # FAKE - equal to M464
        # g-i, from 2024-10-29
        #M438: [-0.4446, 0.5211,-0.1439, 0.0338],
        #M490: [ 0.0884,-0.3097, 0.2242,-0.0387],
        #M517: [ 0.3761,-1.4995, 1.9498,-0.9647, 0.1577],
        M438: [0., 0.5211,-0.1439, 0.0338],
        M490: [0.,-0.3097, 0.2242,-0.0387],
        M517: [0.,-1.4995, 1.9498,-0.9647, 0.1577],
        )[band]
