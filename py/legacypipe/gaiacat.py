...
def gaia_to_cfht(gaia, bands, **kwargs):
    return gaia_to_observed('cfht', gaia, bands, **kwargs)

def gaia_to_decam(gaia, bands, **kwargs):
    return gaia_to_observed('decam', gaia, bands, **kwargs)

def gaia_to_observed(telescope, gaia, bands,
                     average_color=1.4,
                     color_clip=None,
    ...
    coeffs = {
        # 3rd order
        #'u': ('BP', [-2.43766287,  4.89876571, -1.55274027,  0.14436355]),
        # 4th order (Dustin's Untitled488.ipynb)
        ('decam', 'u'): ('BP', [-0.41424252, -1.31861541,  4.92371886, -2.56436345,  0.39205685]),
        ('decam', 'g'): ('G', [-0.1178631039, 0.3650113495, 0.5608615360, -0.2850687702,
                -1.0243473939, 1.4378375491, 0.0679401731, -1.1713172509,
                0.9107811975, -0.3374324004, 0.0683946390, -0.0073089582,
                0.0003230170]),
        ('decam', 'r'): ('G', [0.1139078673, -0.2868955307, 0.0013196434, 0.1029151074,
                0.1196710702, -0.3729031390, 0.1859874242, 0.1370162451,
                -0.1808580848, 0.0803219195, -0.0180218196, 0.0020584707,
                -0.0000953486]),
        ('decam', 'i'): ('G', [0.3396481660, -0.6491867119, -0.3330769819, 0.4381097294,
                0.5752125977, -1.4746570523, 1.2979140762, -0.6371018151,
                0.1948940062, -0.0382055596, 0.0046907449, -0.0003296841,
                0.0000101480]),
        ('decam', 'z'): ('G', [0.4811198057, -0.9990015041, 0.1403990019, 0.2150988888,
        ...
        ('decam', 'N395'): ('G', [ 1.8757,-7.2503,11.9664,-5.8214, 0.9271]),
        # IBIS - Rongpu, 2025-04-07
        ('decam', 'M411'): ('G', [-0.121135807, 0.214202972, -0.432275297, 6.33517298, -6.16359698, -10.5837512, 30.6209588, -32.3682815, 18.961989, -6.68321801, 1.41269689, -0.165375832, 0.00825599733]),
        ('decam', 'M438'): ('G', [-0.0366575264, 0.148435846, -1.73012913, 7.94291264, -2.59147985, -19.9128805, 36.7698794, -31.5884298, 15.9377805, -4.98555542, 0.954462291, -0.102772045, 0.0047791309]),
        ('decam', 'M464'): ('G', [-0.159291847, 0.404280833, 0.216697525, 1.33091203, -1.3403765, -3.65518804, 8.69839989, -8.05791299, 4.14722148, -1.28622435, 0.240118347, -0.0249686426, 0.001115772]),
        ('decam', 'M490'): ('G', [-0.0288551549, 0.102359685, 0.413203971, 1.58167708, -3.59089787, -0.815820939, 9.10026694, -11.3422226, 7.04242478, -2.53797638, 0.539870363, -0.0631013162, 0.003132881]),
        ('decam', 'M517'): ('G', [-0.118259758, 0.328822667, 1.34465039, -2.35947092, -1.99802997, 7.72242161, -5.60664076, -0.265119231, 2.37946742, -1.39398479, 0.383994131, -0.0532835762, 0.00300229245]),
        # CFHT: Dustin's Untitled506.ipynb
        ('cfht', 'M4376'): ('BP', [-0.46545299, -0.37676112,  0.8657153,  -0.19667747]),
    }
    ...
    for b in bands:
        ...
        if color_clip is None and b in ['M411','M438','M464','M490','M517','N395']:
            lo,hi = (0.0, 3.3)
        elif color_clip is None and b in ['M4376']:
            lo,hi = (1.0, 3.0)
