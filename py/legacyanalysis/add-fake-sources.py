...
class FakeDecals(Decals):
    def __init__(self, decals_dir=None, fake_sources=[]):
        super(FakeDecals, self).__init__(decals_dir=decals_dir)
...
class FakeImage(DecamImage):
    def __init__(self, decals, t):
        super(FakeImage, self).__init__(decals, t)
    ...
    def get_tractor_image(self, **kwargs):
        ...
        for src in self.decals.fake_sources:
