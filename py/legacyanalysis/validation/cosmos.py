...
np.savetxt(list10, cosmos10BrickList, fmt='%s')
np.savetxt(list11, cosmos11BrickList, fmt='%s')
np.savetxt(list12, cosmos12BrickList, fmt='%s')
np.savetxt(list20, cosmos20BrickList, fmt='%s')
np.savetxt(list21, cosmos21BrickList, fmt='%s')
np.savetxt(list22, cosmos22BrickList, fmt='%s')
np.savetxt(list30, cosmos30BrickList, fmt='%s')
np.savetxt(list31, cosmos31BrickList, fmt='%s')
np.savetxt(list32, cosmos32BrickList, fmt='%s')
np.savetxt(list40, cosmos40BrickList, fmt='%s')
np.savetxt(list41, cosmos41BrickList, fmt='%s')
np.savetxt(list42, cosmos42BrickList, fmt='%s')
